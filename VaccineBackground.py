...
class VaccineBackground:
    ...
    def __init__(self):
        ...
        self.__stars = BackgroundImage(self.__images.stars, Constants.SLOWING_STARS)
        self.__back_buildings = BackgroundImage(self.__images.back_buildings, Constants.SLOWING_BACK_BUILDINGS)
